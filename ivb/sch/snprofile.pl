...
--depth             Optional. Only report cells to given depth. Depth 0 is top level and is default.
...
my $adtemplate_prefix = '(y|a)(8)';
my $stdcell_prefix = '(y|a)(9|g|n|i|x)';
my $layoutonly_prefix = '(gsr|ivb)_';

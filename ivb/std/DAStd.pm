# $Id: DAStd.pm,v 1.1 2010/01/08 19:57:36 mroha Exp $
...
BEGIN {
  ...
  our (@ISA, @EXPORT);
  @ISA = qw(Exporter);
  @EXPORT = qw(&GetExeName &GetDate &DeleteFiles &DeleteDirTrees &DeleteFilesAndDirTrees &CreateDirTrees &ManipFile &GetDate &Tcsh &Pipe &PollForFile &CheckForMissingFlags &Usage &Round &GetSite &ReadEnvironmentFile &CaptureEnvironment &SetEnvironment &ClearEnvironment &RcsCo &CopyFilesToDir &ConvertMonthStringToInt &ConvertElapsedTimeToSeconds &GetCodeDir &ReadListFile);
}
...
sub Pipe {
  ...
  $logfh->infoq("Opening pipe to process: \'$cmd\'");

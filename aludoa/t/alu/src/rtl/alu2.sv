//ALU : p2v0
module alu2(`include "alu2_ports_declaration.sv");
  `include "alu2_params.sv"
  `include "alu2_ports_definition.sv"
  ...
  always_ff @(posedge clktop)
    datainf <= datain;

  ctech_lib_nor i_ctech_lib_nor (
    .a(select),
    .b(datainf),
    .o1(output_nor)
  );

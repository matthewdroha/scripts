...
Filename: readHsd.pl
Project: ihdk
Original Author: Mike Farabee (Intel);  Updated by Matthew Roha for MMG and MIG
...
my $help_message = <<HERE
    ...
    Sample CSV file:
     project,project_stepping,status,effort_category,title,ipmodule,comments,circuit_tag="unknown"
    ...
    <AddHSD>
    <ticket project="WSM" project_stepping="a0" status="Open" effort_category="Library.Cell Layout" title="test from Mike" ipmodule="exe.fpu.ckct0fox" comments="test data" circuit_tag="unknown" />
    <ticket>
        <project>ALP</project> 
        <project_stepping>A0</project_stepping>
        <status>Open</status> 
        <effort_category>CDC1.PD-Only (PD Use Only)</effort_category>
        <title>Batch submission test for Melvin and Gabriel</title>
        <ip_module>ALP.DDR.CLKLOGIC.ip10xddrtx_clklogic</ip_module>
        <comments>This is a test ticket orginated from readHsd.pl</comments>
        <circuit_tag>NA</circuit_tag>
	<mail_list>pkbhatt;meperez1;gabustam;ggonen</mail_list>
    </ticket>
    </AddHSD>
...
my $xmlData=();
my %csvData=();
my @requiredFields=("project","project_stepping","effort_category","title","ip_module","comments","circuit_tag","status");
